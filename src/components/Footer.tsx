...
export default function Footer() {
  return (
    <>
      <footer className="mt-20 bg-neutral-100/70 text-center text-neutral-600 ">
          ...
          <div className="relative mb-7">
            <form action="">
              <div className="grid grid-cols-1 md:grid-cols-3 items-center justify-center gap-5 mb-6">
                ...
                <div>
                  <label className="sr-only">Small input</label>
                  <input
                    type="email"
                    id="inputSignUp"
        ...
        <div className="bg-transparent p-6 text-center  flex justify-center items-center">
          <span>© 2023 Copyright: </span>

          <a className="mx-3" href="#">
            <img src="/logo.png" className="h-5" alt="TE Logo" loading="lazy" />
          </a>
